...
namespace WFXPatch.Msgbox
{
    public partial class FormMessageBox : Form
    {
        ...
        #region "Constructors: FormMessageBox"
            ...
            public FormMessageBox( string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton btnDefault )
            {
                InitializeComponent( );
                InitializeItems( );
                this.PrimaryColor           = primaryColor;
            ...
            public FormMessageBox( string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton btnDefault, MessageBoxOptions options )
            {
                InitializeComponent( );
                InitializeItems( );
                this.PrimaryColor           = primaryColor;
                ...
                switch ( buttons )
                {
                    ...
                    */
                    ...
                    case MessageBoxButtons.OK:
                        ...
                        btn_1.Text          = Lng.btn_template_ok;
                    ...
                    */
                    ...
                    case MessageBoxButtons.OKCancel:
                        ...
                        btn_2.Text          = Lng.btn_template_cancel;
                    ...
                    */
                    ...
                    case MessageBoxButtons.RetryCancel:
                        ...
                        btn_1.Visible       = true;
                        btn_1.Location      = new Point(xCenter - ( btn_1.Width / 2) - 5, yCenter );
                        btn_1.Text          = Lng.btn_template_retry;
                    ...
                    */
                    ...
                    case MessageBoxButtons.YesNo:
                        ...
                        btn_1.Visible       = true;
                        btn_1.Location      = new Point(xCenter - ( btn_1.Width / 2) - 5, yCenter );
                        btn_1.Text          = Lng.btn_template_yes;
                        btn_1.DialogResult  = DialogResult.Yes;

                        btn_2.Visible       = true;
                        btn_2.Location      = new Point( xCenter + ( btn_2.Width / 2 ) + 5, yCenter );
                        btn_2.Text          = Lng.btn_template_no;
                    ...
                    */
                    ...
                    case MessageBoxButtons.YesNoCancel:
                        ...
                        btn_3.Text          = Lng.btn_template_cancel;
